...
\end{itemize}
\textit{FEA and Experimental Studies for Reduction of Wear in Human Hip Prosthesis\hfill Oct 2013 - April 2014}
\begin{itemize}
\item Tested using Finite Element Analysis and experiments, the use of Functionally Graded Materials and Multi-layer coatings as alternatives to materials currently used in hip prosthesis, with a view to reduce wear rate and prolong life of implants 
\end{itemize}
