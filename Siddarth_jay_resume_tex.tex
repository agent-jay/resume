...
\end{itemize}
\textbf{Real-time Map building for mobile robotics using Ultrasound \hfill April 2012 - October 2012}
\begin{itemize}
...
\end{itemize}
\textbf{Created a clone of Atari Pong\hfill October 2011 - November 2011}
\begin{itemize}
